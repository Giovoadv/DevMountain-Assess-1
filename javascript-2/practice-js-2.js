...
let gitDefinition = "Git is a DevOps tool used for source code management";
...
//CODE HERE
let clone = {
    description: "The git clone command copies an existing Git repository.",
    code: "git clone"
}
...
//CODE HERE
let add = {
    description: "The git add command adds a change in the working directory to the staging area",
    code: "git add"
}
